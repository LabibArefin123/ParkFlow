...
@section('content')
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_base.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_header.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_stats.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_filter.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_table.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_status.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_pagination.css') }}">
    <link rel="stylesheet" href="{{ asset('css/custom_backend/parking_session/parking_session_resp.css') }}">
